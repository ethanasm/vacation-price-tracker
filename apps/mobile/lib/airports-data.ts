 ...
 *
 * Mobile twin of apps/web/src/data/airports.ts — keep the two files in
 * lockstep (same dataset, same shape) so the From/To typeahead offers the
 * same airports on both surfaces. This data is static because airport codes
 * rarely change; update periodically by re-running the generation script.
 */
